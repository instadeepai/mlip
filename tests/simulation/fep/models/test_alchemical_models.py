...
_EXPECTED_ENERGIES = {
    ...
    ("mace", 0.25): -42.000332,
    ("mace", 0.0): -42.000496,
    ("nequip", 1.0): -41.965302,
    ("nequip", 0.75): -41.962280,
    ("nequip", 0.5): -41.959156,
    ("nequip", 0.25): -41.955925,
    ("nequip", 0.0): -41.952583,
    ("visnet", 1.0): -42.801384,
    ("visnet", 0.75): -42.801403,
    ("visnet", 0.5): -42.80143,
    ("visnet", 0.25): -42.80146,
    ("visnet", 0.0): -42.80151,
    ("esen", 1.0): 97.184235,
    ("esen", 0.75): 96.084396,
    ("esen", 0.5): 93.778564,
